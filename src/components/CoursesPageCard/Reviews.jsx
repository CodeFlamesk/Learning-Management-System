...
import ReviewAuthor from "./img/ReviewsAuthot.webp";
...
const Reviews = () => {
    ...
    return (
        <div className="flex pt-6 pb-6">
            <div className="w-full lg:basis-[65%] border-t pb-6 border-grey-border relative">
                ...
                <div className="flex flex-col gap-4 pt-92w">
                    ...
                    <div className="flex flex-col ft:flex-row gap-4 mde:gap-8 p-6 border border-grey-border rounded-2xl sm:justify-between items-center">
                        <div className="flex flex-row ft:flex-col mde:flex-row gap-3 justify-center items-center w-full">
                            <img src={ReviewAuthor} alt="Author" className="w-[60px] h-[60px] rounded-full" />
                            <p className=" text-lg font-semibold text-grey-900 w-24 ft:flex-wrap ">Mark Doe</p>
                        </div>
