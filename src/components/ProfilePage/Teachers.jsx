...
const Teachers = () => {
    ...
    return (
        ...
        <div className="flex flex-col w-full pb-6 overflow-hidden">
            <Subheading title="Message" />
            <div className="flex flex-col  border border-grey-border py-4 rounded-2xl mt-4 overflow-hidden ">
                ...
                <div className="flex flex-col border-y border-grey-border pt-7 px-4 overflow-y-auto overflow-x-hidden max-h-[490px] custom-scrollbar ">
