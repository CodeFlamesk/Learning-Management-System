        ...
        <div className="flex flex-col relative ">
            ...
            <form className="flex flex-col w-full border border-grey-border py-6 px-6 rounded-2xl ">
                <div className="flex flex-col  gap-y-4">
                    <div className="flex flex-col tb:flex-row w-full gap-x-60w tb:justify-between gap-y-4">
                        <label htmlFor="FirstName" className="flex flex-col w-full">
                            ...
                            <input id="FirstName" type="text" placeholder="Name of card" name="FirstName" className="inputs-checkout input-shadow " />

                        </label>

                        <label htmlFor="LastName" className="flex flex-col w-full">
                            <SmallText title="Last Name" styles="flex inline-flex cursor-pointer" />
                            <input id="LastName" type="text" name="LastName" placeholder="Card Number" className="inputs-checkout input-shadow " />
                        </label>
                    </div>
                    <div className="w-full  tb:w-[46.5%]">
                        ...
                        <input id="Headline" type="text" placeholder="Headline" name="Headline" className="inputs-checkout input-shadow " />
                ...
                <textarea
                    ...
                    class="min-h-120w max-h-200w inputs-checkout input-shadow  resize-y p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-blue-400">
                </textarea>
            ...
            <form className="inline-block flex-col w-full border border-grey-border mt-6     p-6 rounded-2xl ">
                ...
                <input id="Website" type="text" placeholder="Website" name="Website" className="inputs-checkout input-shadow " />
                <label htmlFor="Formerlytwitter">
                    <SmallText title="X(Formerly twitter)" styles="flex inline-flex cursor-pointer pt-4" />
                </label>
                <input id="Formerlytwitter" type="text" placeholder="Formerlytwitter" name="Formerlytwitter" className="inputs-checkout input-shadow " />
                <label>
                    <SmallText title="Linkdin" styles="flex inline-flex cursor-pointer pt-4" />
                    <input type="text" placeholder="Linkdin" name="Linkdin" className="inputs-checkout input-shadow " />
                </label>
                <label>
                    <SmallText title="Youtube" styles="flex inline-flex cursor-pointer pt-4" />
                    <input type="text" placeholder="Youtube" name="Youtube" className="inputs-checkout input-shadow " />
                </label>
                <label>
                    <SmallText title="Facebook" styles="flex inline-flex cursor-pointer pt-4" />
                    <input type="text" placeholder="Facebook" name="Facebook" className="inputs-checkout input-shadow " />
                </label>
